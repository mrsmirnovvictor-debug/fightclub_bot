...
def help_text(turn_timeout: int = 30) -> str:
    return (
        ...
        "В бою у каждого своя панель: слева удары по зонам, справа блоки. "
        "Блок закрывает две смежные зоны, со щитом — три. Соперник твоих "
        "нажатий не видит: бот отвечает лично тому, кто нажал.\n"
