...
def help_text(turn_timeout: int = 30, round_break: int = 30) -> str:
    return (
        ...
        "Удар один, блок один и закрывает две смежные зоны — у всех и всегда. "
        "Класс на удары и блоки не влияет: разница между классами живёт в "
        "характеристиках. Соперник твоих нажатий не видит: бот отвечает лично "
        "тому, кто нажал.\n"
        "Рука одна: двух ударов за ход не сделать никак. Без оружия бьют "
