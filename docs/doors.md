...
Дом и район участка зовутся `vcpd` и `vcpd_hospital_district`: так
названы файлы в хранилище. На вывеске у дома «Полицейский участок», и
расходиться это не может — название берётся из справочника, а адрес
